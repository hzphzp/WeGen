...
class ContinuousLVLM(nn.Module):
    ...
    def __init__(self, llm, input_resampler, output_resampler, lm_loss_scale=1.0, rec_loss_scale=1.0, add_patch_pos=False, vit_down=False, mse=False, adapter=None) -> None:
        super().__init__()
        self.llm = llm
    ...
    def forward(self, input_ids, attention_mask, labels, image_embeds, embeds_gen_mask, embeds_cmp_mask, ids_gen_mask,
                ids_cmp_mask, patch_positions=None, *args, **kwargs):
