...
class ResamplerXLV2(nn.Module):
    ...
    def __init__(
        ...
        self.unet_proj_1 = nn.Linear(self.in_dim, output1_dim)
        self.unet_proj_2 = nn.Linear(self.in_dim, output2_dim)
        output3_dim = output3_dim if output3_dim is not None else output2_dim
        self.unet_attnpool = AttentionPool2d(num_queries, self.in_dim, heads, output3_dim)
...
# give a name of the model
class AvgPoolQuery(nn.Module):
    def __init__(self, n_query=64):
        super().__init__()
