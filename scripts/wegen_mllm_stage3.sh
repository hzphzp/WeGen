...
export ASCEND_MODULE_LOG_LEVEL=1  
export  ASCEND_PROCESS_LOG_PATH=/dockerdata/log
echo '--------------------------'
...
torchrun --nnodes=$NNODES \
    ...
    --train_dataset ${PROJ_PATH}/configs/data/wegen_stage3.yaml \
